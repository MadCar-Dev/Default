!scriptcard {{ 
  ...
  --/|Script Name : Increase Madness Level
  --/|Version     : 2.0
  --/|Requires SC : 1.3.7+, ChatSetAttr
  --/|Author      : Will M.

  --/|Description : Based on Madness mechanic in OOtA - Increases the madness level and tracks in a Madness_Level character attribute
  --/|               
  --/|              
